...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 管理员管理 <span class="c-gray en">&gt;</span> 管理员列表 <a class="btn btn-success radius r"
	...
	<div class="page-container">
		<div class="text-c">
			<form class="Huiform">
				<input type="text" class="input-text" style="width: 250px" placeholder="管理员名称" id="username" name="username">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			...
			<span class="l"> <a href="javascript:;" onclick="admin_add('添加管理员','adminAddInput','','410')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span>
		</div>
		<div class="mt-20">
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			table = $('#example').DataTable({
				...
				"columnDefs" : [ {
					...
					"sClass" : "f-14",
					"render" : function(data, type, full) {
						var str = "<a title='编辑' style='text-decoration:none' class='ml-5' href='javascript:;' onclick='admin_edit(\"编辑管理员\",\"adminUpdateInput?id="+data+"\",600,410)'><i class='Hui-iconfont'>&#xe6df;</i></a>";
						   str += "<a title='删除' style='text-decoration:none' class='ml-5' href='javascript:;' onclick='admin_del(this,"+data+")'><i class='Hui-iconfont'>&#xe6e2;</i></a>";
						return str;
					}
				} ]
			});
		...
		function admin_del(obj, id) {
			layer.confirm('管理员删除须谨慎，确认要删除吗？', function(index) {
				$.post("adminDelete",{id:id},function(data){
					if(data.success){
						search1();
						layer.msg(data.msg, {
							icon : 1,
