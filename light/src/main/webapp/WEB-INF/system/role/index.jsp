...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 管理员管理 <span class="c-gray en">&gt;</span> 角色管理 <a class="btn btn-success radius r"
	...
	<div class="page-container">
		<div class="text-c">
			<form class="Huiform">
				<input type="text" class="input-text" style="width: 250px" placeholder="角色名称" id="name" name="name">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			...
			<span class="l"> <a href="javascript:;" onclick="role_add('添加角色','roleAddInput','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a></span>
		</div>
		<div class="mt-20">
			...
			table = $('#example').DataTable({
				...
				"columnDefs" : [ {
					...
					"render" : function(data, type, full) {
						var str = "<a title='编辑' style='text-decoration:none' class='ml-5' href='javascript:;' onclick='role_edit(\"编辑角色\",\"roleUpdateInput?id="+data+"\",800,510)'><i class='Hui-iconfont'>&#xe6df;</i></a>";
						   str += "<a title='删除' style='text-decoration:none' class='ml-5' href='javascript:;' onclick='role_del(this,"+data+")'><i class='Hui-iconfont'>&#xe6e2;</i></a>";
						return str;
					}
				} ]
			});
